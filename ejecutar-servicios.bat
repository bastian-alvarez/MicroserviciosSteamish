@echo off
echo ========================================
echo   Microservicios GameStore - Laragon
echo ========================================
echo.
echo Este script te ayudara a ejecutar los microservicios
echo.
echo IMPORTANTE: Asegurate de que:
echo   1. Laragon este corriendo con MySQL activo
echo   2. Las bases de datos esten creadas (ejecuta setup-databases.sql)
