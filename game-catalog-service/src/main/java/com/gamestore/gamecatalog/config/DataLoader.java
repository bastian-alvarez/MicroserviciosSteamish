...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadInitialData() {
        ...
        Category estrategiaCat = categoryRepository.findByNombre("Estrategia").orElseThrow();
        ...
        Genre estrategiaGen = genreRepository.findByNombre("Estrategia").orElseThrow();
        ...
        List<Game> games = Arrays.asList(
            new Game(null, "The Witcher 3: Wild Hunt", 
                ...
                29990.0, 50, "https://images.unsplash.com/photo-1511512578047-dfb367046420?w=500", 
                "CD Projekt RED", "2015", rpgCat.getId(), rpgGen.getId(), true, 0),
            ...
            new Game(null, "Cyberpunk 2077", 
                ...
                39990.0, 30, "https://images.unsplash.com/photo-1550745165-9bc20b82fabe?w=500", 
                "CD Projekt RED", "2020", rpgCat.getId(), accionGen.getId(), true, 25),
            ...
            new Game(null, "FIFA 24", 
                ...
                49990.0, 100, "https://images.unsplash.com/photo-1551958219-acbc608c6377?w=500", 
                "EA Sports", "2023", deportesCat.getId(), deportesGen.getId(), true, 0),
            ...
            new Game(null, "Call of Duty: Modern Warfare", 
                ...
                44990.0, 75, "https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=500", 
                "Infinity Ward", "2019", accionCat.getId(), accionGen.getId(), true, 15),
            ...
            new Game(null, "Assassin's Creed Valhalla", 
                ...
                34990.0, 60, "https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=500", 
                "Ubisoft", "2020", aventuraCat.getId(), aventuraGen.getId(), true, 0),
            ...
            new Game(null, "Minecraft", 
                ...
                19990.0, 200, "https://images.unsplash.com/photo-1511512578047-dfb367046420?w=500", 
                "Mojang Studios", "2011", aventuraCat.getId(), aventuraGen.getId(), true, 0),
            ...
            new Game(null, "Grand Theft Auto V", 
                ...
                24990.0, 80, "https://images.unsplash.com/photo-1550745165-9bc20b82fabe?w=500", 
                "Rockstar Games", "2013", accionCat.getId(), accionGen.getId(), true, 30),
            ...
            new Game(null, "The Legend of Zelda: Breath of the Wild", 
                ...
                54990.0, 40, "https://images.unsplash.com/photo-1511512578047-dfb367046420?w=500", 
                "Nintendo", "2017", aventuraCat.getId(), aventuraGen.getId(), true, 0),
            ...
            new Game(null, "Counter-Strike 2", 
                ...
                0.0, 999, "https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=500", 
                "Valve", "2023", accionCat.getId(), accionGen.getId(), true, 0),
            ...
            new Game(null, "Red Dead Redemption 2", 
                ...
                39990.0, 55, "https://images.unsplash.com/photo-1550745165-9bc20b82fabe?w=500", 
                "Rockstar Games", "2018", aventuraCat.getId(), aventuraGen.getId(), true, 20),
            ...
            new Game(null, "Elden Ring", 
                ...
                49990.0, 35, "https://images.unsplash.com/photo-1511512578047-dfb367046420?w=500", 
                "FromSoftware", "2022", rpgCat.getId(), accionGen.getId(), true, 0),
            
            new Game(null, "God of War", 
                "Únete a Kratos y su hijo Atreus en un viaje épico a través de los reinos nórdicos.", 
                44990.0, 45, "https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=500", 
                "Santa Monica Studio", "2018", accionCat.getId(), aventuraGen.getId(), true, 10)
        );
