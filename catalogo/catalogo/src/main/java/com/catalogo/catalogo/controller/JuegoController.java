...
@Tag(name = "Juegos", description = "CRUD de juegos (catálogo)")
@RestController
...
public class JuegoController {
  ...
  @Operation(summary = "Crear juego (ADMIN)")
  ...
  @Operation(summary = "Actualizar juego (ADMIN)")
  @PreAuthorize("hasRole('ADMIN')")
  @PutMapping("/{id}")
  ...
  @Operation(summary = "Eliminar juego (ADMIN)")
  @PreAuthorize("hasRole('ADMIN')")
  @DeleteMapping("/{id}")
